...
class DataGenerator:
    ...
    def pcrlv2_chest_pretask(self):
        ...
        train_dataset = Pcrlv2ChestPretask(
            args,
            train_imgs,
            ...
            spatial_transform_local=spatial_transform_local,
            num_local_view=6,
        )
    ...
    def pcrlv2_luna_pretask(self):
        ...
        x_train, x_valid, _ = get_luna_list(
            args,
            train_fold,
            valid_fold,
            valid_fold,
