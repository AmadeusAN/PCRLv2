...
import random
from pcrl_utils import adjust_learning_rate, AverageMeter
...
def train_pcrlv2(args, data_loader, out_channel=3):
    ...
    for epoch in range(0, args.epochs + 1):
        ...
        loss, mg_loss, prob = train_pcrlv2_inner(
        ...
        if epoch % 100 == 0 or epoch == 240:
            ...
            state = {
                "opt": args,
                "state_dict": model.module.model.encoder.state_dict(),
